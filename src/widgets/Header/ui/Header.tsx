  ...
  return (
    <header className={classNames(styles.Header, {}, [className])}>
      <div className={styles.header_logo__container}>
        <img
          className={styles.header_logo__pish}
          alt="Логотип ПИШ"
          src={pish}
        ></img>
        <a href="https://sfedu.ru/" target="_blank">
          <img
            className={styles.header_logo__ufu}
            alt="Логотип Юфу"
            src={ufu}
          ></img>
        </a>
      ...
      <div className={styles.header_nav__container}>
        <nav className={styles.header_nav}>
          <a href="#areasOfTraining" className={styles.header_nav__link}>
            Направления подготовки
          </a>
          <a href="#events" className={styles.header_nav__link}>
            Мероприятия
          </a>
          <a href="#footer" className={styles.header_nav__link}>
            Контакты
          </a>
        </nav>
        <button
