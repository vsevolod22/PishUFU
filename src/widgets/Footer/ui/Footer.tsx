...
const Footer = ({className} : FooterProps) => {
    return (
        <footer className={classNames(styles.Footer, {}, [className])}>
            <div className={styles.footer_img__container}><img alt='backImg' src={round}/></div>
           <div className={styles.footer_contacts__container}>
            ...
            <div className={styles.footer_address__container}>
                ...
                <span className={styles.footer_address}>Телефон: 8 (863) 218-40-00 доб. 30116</span>
                <span className={styles.footer_address}>Адрес: 347900, ул. Петровская, 81, г. Таганрог. Ростовская область</span>
            </div>
        </footer>
    );
};
